...
import com.example.language.databinding.CustomWhileBinding

class CustomWhileView @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = CustomWhileBinding.inflate(LayoutInflater.from(context), this)
