...
import com.example.language.databinding.CustomOperationsBinding

class CustomOperationsOnValView @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = CustomOperationsBinding.inflate(LayoutInflater.from(context), this)
